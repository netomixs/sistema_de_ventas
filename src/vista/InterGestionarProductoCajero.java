 ...
 * 
 */
public class InterGestionarProductoCajero extends javax.swing.JInternalFrame implements VistaFormInterfaz<Producto> {
     ...
     *
     */
    public InterGestionarProductoCajero() {
        initComponents();
...
// Crear un filtro de documento para limitar la cantidad de caracteres
    ...
    public void cargarTabla() {
        DefaultTableModel datos = ctrlProductos.getTablaCajero();
